...
namespace HugoHelper
{
	partial class AppDelegate
	{
		...
		[Action ("onClickSetMarkdownApp:")]
		partial void onClickSetMarkdownApp (Foundation.NSObject sender);

		[Action ("onClickShowServerLogs:")]
		partial void onClickShowServerLogs (Foundation.NSObject sender);

		[Action ("onClickStartHugulpWatcher:")]
		partial void onClickStartHugulpWatcher (Foundation.NSObject sender);
